        ...
        <ul>
            <li>
                <div class="sidenav_icon">
                    <div class="icon_box">
                        <font-awesome-icon icon="fa-solid fa-user" class="icon_img"/>
                    </div>
                </div>
            ...
            <li>
                <div class="sidenav_icon">
                    <div class="icon_box">
                        <font-awesome-icon icon="fa-solid fa-shirt" class="icon_img"/>
                    </div>
                </div>
                <div class="sidenav_title">
                    <h4>穿搭管理</h4>
            ...
            <li>
                <div class="sidenav_icon">
                    <div class="icon_box">
                        <font-awesome-icon icon="fa-solid fa-heart" class="icon_img"/>
                    </div>
                </div>
                <div class="sidenav_title">
                    <h4>收藏管理</h4>
            ...
            <li>
                <div class="sidenav_icon">
                    <div class="icon_box">
                        <font-awesome-icon icon="fa-solid fa-bag-shopping" class="icon_img"/>
                    </div>
                </div>
                <div class="sidenav_title">
                    <h4>訂單紀錄</h4>
