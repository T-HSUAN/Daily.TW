<template>
    <div class="about_bg">
        <div class="about_banner">
            <div class="banner_deco_top">
                <span>行程規劃 X 穿搭推薦</span>
            </div>
            <div class="banner_deco_left">
                <span
                    >S<br />I<br />N<br />C<br />E<br />2<br />0<br />2<br />3</span
                >
            </div>
            ...
            <div class="about_boy">
                <img src="~@/assets/img/layout/about_banner.png" alt="" />
            </div>
        </div>
    </div>
    <div class="about_us">
        <div class="about_swiper">
            <div class="swiper_wrap">
                <img src="~@/assets/img/layout/about_pic1.png" alt="" />
            </div>
            <div class="slogan_deco">
                <img src="~@/assets/img/layout/about_slogan.png" alt="" />
            </div>
        </div>
        <div class="about_desc">
            ...
            <div class="desc_subtitle">
                ...
                <div class="about_arrow">
                    <img src="~@/assets/img/layout/about_arrow.png" alt="" />
                    <span>開始你的專屬旅著 !</span>
                </div>
            </div>
            <div class="desc_summary">
                <p>
                    日日旅著提供一日行程規劃及穿搭靈感，讓旅客省下前置作業時間，安排出遊更便利，在這裡你能找到各式各樣的一天份輕旅行，也能分享出遊穿搭、展現個人風格，滿足你隨時都能說走就走
                    !
                </p>
            </div>
            <div class="about_duckprint">
                <div class="about_duck">
                    <img src="~@/assets/img/layout/about_duck.png" alt="" />
                </div>
                <div class="about_footprint"></div>
            </div>
        </div>
    </div>
    <div class="about_us_wave"></div>
                ...
                <div class="service_card">
                    <div class="card_front">
                        ...
                        <div class="card_main">
                            <h3>專屬旅著</h3>
                            <img
                                src="~@/assets/img/layout/about_icon_duck.png"
                                alt=""
                            />
                        </div>
                    </div>
                    <div class="card_back">
                        ...
                        <div class="card_main">
                            ...
                            <img
                                src="~@/assets/img/layout/about_service1.png"
                                alt=""
                            />
                        </div>
                    </div>
                ...
                <div class="service_card">
                    <div class="card_front">
                        ...
                        <div class="card_main">
                            <h3>出遊特輯</h3>
                            <img
                                src="~@/assets/img/layout/about_icon_map.png"
                                alt=""
                            />
                        </div>
                    </div>
                ...
                <div class="service_card">
                    <div class="card_front">
                        ...
                        <div class="card_main">
                            <h3>穿搭特輯</h3>
                            <img
                                src="~@/assets/img/layout/about_icon_wear.png"
                                alt=""
                            />
                        </div>
                    </div>
                ...
                <div class="service_card">
                    <div class="card_front">
                        ...
                        <div class="card_main">
                            <h3>景點票券</h3>
                            <img
                                src="~@/assets/img/layout/about_icon_ticket.png"
                                alt=""
                            />
                        </div>
                    </div>
    ...
    <div class="about_service_wave"></div>
    ...
    <div class="about_info">
        <div class="info_logo">
            <img src="~@/assets/img/layout/about_logo.png" alt="" />
        </div>
        <div class="info_desc">
            <div class="info_main">
                <h3>日日旅著 Daily.TW</h3>
                <a href="tel:0800000000">電話 : 0800-000-000</a>
                <a href="mailto:service@dailytw.com"
                    >E-MAIL : service@dailytw.com</a
                >
            </div>
    ...
    .about_desc {
        ...
        .about_duckprint {
            ...
            .about_footprint {
                width: 225px;
                height: 55px;
                background-image: url(~@/assets/img/layout/about_footprint_sm.png);
                ...
                @media (min-width: $md) {
                    width: 460px;
                    height: 83px;
                    background-image: url(~@/assets/img/layout/about_footprint_xl.png);
                }
            }
        }
    }
        ...
        .service_card_wrap {
            ...
            .service_card {
                ...
                .card_side_deco {
                    ...
                    border-right: 2px solid $textColor_default;
                    box-sizing: border-box;
                    flex-shrink: 0;
                    @media (min-width: $md) {
                        width: 30px;
