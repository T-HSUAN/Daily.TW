<template>
    <div class="oott_edit_wrap">
        <div class="post_title">
            <h2>穿搭管理</h2>
        </div>

        <div class="oott_edit_container">
            <!-- Sidebar -->
                ...
                <div class="post_content_container">
                    <div class="photo_area">
                        <div class="edit_subtitle">
                            ...
                            <!-- 如果通過 -->
                            <div class="review_feedback" v-if="tableData.oott_img_feedback == null">
                                V 審核通過
                            </div>
                            <!-- 如果需要修改 -->
                    ...
                    <div class="text_area">
                        ...
                        <div class="season_tags">
                            <div class="edit_subtitle">
                                ...
                                <!-- 如果通過 -->
                                <div class="review_feedback" v-if="tableData.oott_season_feedback == null">
                                    V 審核通過
                                </div>
                                <!-- 如果需要修改 -->
...
export default {
    ...
    methods: {
        ...
        fetchPostDetails() {
            axios.get(`${this.$URL}/oottEditView.php?oottId=${this.oottId}`)
