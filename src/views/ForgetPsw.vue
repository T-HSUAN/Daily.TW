            ...
            <div v-if="tabActive == item.tab" class="canvas">
                ...
                <div class="forget" :class="{ active: isActive }">
                    ...
                    <div class="cancel_group">
                        <router-link to="/" @click="handleClick" class="cancel_btn">
                            取消
                        </router-link>
                        <!-- 利用 v-if/v-else 控制是否顯示 router-link -->
                        <router-link v-if="item.tab == 2" to="/forget_psw" @click="handleSubmit" class="btn">
                            送出
                        </router-link>
                        <router-link v-else v-if="item.tab == 1" to="/forget_psw" @click="handleClick" class="btn">
                            送出
                        </router-link>
                    </div>
                </div>
